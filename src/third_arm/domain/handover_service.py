...
from third_arm.core.errors import ArmNotReadyError
...
class HandoverService:
    ...
    TODO: inject BundleWriter and write trace events at each step.
    """

    def __init__(self, state_machine: StateMachine, driver: ArmDriverABC) -> None:
