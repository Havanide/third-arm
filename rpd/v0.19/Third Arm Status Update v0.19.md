...
### docs/api/openapi.yaml — Stage 1 API surface fully synced

The `docs/api/openapi.yaml` has been corrected to match the real Stage 1 implementation.
8 gaps were identified and fixed.
...
All Stage 1 implementation deliverables and their API documentation are now synchronized:
...
- OpenAPI spec: complete and synced (this version)
